            ...
            <div className="card p-4">
              <div className="row">
                ...
                <div className="col-lg-4 col-xl-4 col-md-4 col-sm-12">
                  <div class="form-group mt-2">
                    <label for="productRetailPrice">
                      Product Retail Price{" "}
                    </label>
                    <input
                      type="number"
                      value={priceCalculations.retailPrice}
                      onChange={(e) => {
                ...
                <div className="col-lg-4 col-xl-4 col-md-4 col-sm-12">
                  <div class="form-group mt-2">
                    ...
                    <input
                      type="number"
                      value={priceCalculations.profit}
                      class="form-control"
                      id="productSellingPrice"
                ...
                <div className="col-lg-6 col-xl-6 col-md-6 col-sm-6">
                  <div class="form-group mt-2">
                    ...
                    <div className="btns-area">
                      <Button
                        variant="outlined"
                        className={addDiscount === "yes" && `add-discount-yes`}
                        onClick={() => {
                          setAddDiscount("yes");
                        }}
                      >
                  ...
                  <>
                    <div className="col-lg-6 col-xl-6 col-md-6 col-sm-12">
                      <div class="form-group mt-2">
                        ...
                        <input
                          type="number"
                          value={priceCalculations.discount}
                          onChange={(e) => {
                            setPriceCalculations({
                              ...priceCalculations,
                              discount: e.target.value,
                              priceAfterDiscount:
                                priceCalculations.sellPrice -
                                priceCalculations.sellPrice *
                                  (e.target.value / 100),
                            });
                            updateValues(e);
                    ...
                    <div className="col-lg-6 col-xl-6 col-md-6 col-sm-12">
                      <div class="form-group mt-2">
                        ...
                        <input
                          type="number"
                          value={priceCalculations.priceAfterDiscount}
                          class="form-control"
