...
const UpdateHeader = () => {
    ...
    useEffect(()=>{
        ...
        axios.get("http://localhost:5000/api/fetched-header")
        .then((response)=>{
    ...
    const updateHeaderFun = async () => {
        ...
        await axios.put("http://localhost:5000/api/update-header", formData, {
            headers: {
    ...
    const updateSocialFiles = (e, index) => {
        const tempHeaderDetails = [...headerDetails.social];
        const socialObject = { ...tempHeaderDetails[index] };
    
        // Update the specific property in the social object.
        socialObject[e.target.name] = e.target.files[0];
                            ...
                            <div className="row">
                                <div className="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="Enter name" name='name' onChange={updateValues} value={headerDetails.name}  />
                                ...
                                <div className="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="file" class="form-control" id="logo" name='logo' onInput={updateFiles}  />
                                ...
                                <div className="row mt-4">
                                    ...
                                    <div className="col-lg-6 col-xl-6 col-md-6 col-sm-12 " style={{ display: "flex", justifyContent: "end" }} >
                                        <IconButton className='add-btn-green'
                                        ...
                                        <div className="border-card row" key={index}>
                                            <div className="col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="icon-name" placeholder="Enter name" name='name' value={item.name} onChange={(e)=>updateSocialValues(e, index)} />
                                            ...
                                            <div className="col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="file" class="form-control" id="icon-logo" name='icon'  onChange={(e)=>updateSocialFiles(e, index)} />
                                            ...
                                            <div className="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="icon-url" placeholder="Enter url" name='url' value={item.url} onChange={(e)=>updateSocialValues(e, index)} />

                                                </div>
                                            </div>


                                            <div className="col-lg-12 col-xl-12 col-md-12 col-sm-12" style={{ display: "flex", justifyContent: "end" }}>
                                                <IconButton className='red-btn-color' onClick={() => deleteSocial(index)}>
                                                    <DeleteForeverIcon />
                                                </IconButton>
                                ...
                                <div className="col-lg-12 col-xl-12 col-md-12 col-sm-12 mt-2" style={{ display: "flex", justifyContent: "end" }}>
                                    <Button onClick={updateHeaderFun} variant='contained' className='crud-submit-btns' startIcon={<AddCircleIcon />} >Save</Button>
                                </div>
