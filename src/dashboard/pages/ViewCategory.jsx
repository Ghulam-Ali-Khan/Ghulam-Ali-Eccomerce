              ...
              <TableBody>
                {categoriesData.map((row) => (
                  ...
                  >
                    ...
                    <TableCell align="right"> <img src={`${url}uploads/categories/${row.cardImage}`} alt="" /> </TableCell>
                  ...
                  <div className="card p-4 " style={{ marginTop: "5rem" }}>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4 col-xl-4 col-md-4 col-sm-12">
                        <img src={`${url}uploads/categories/${singleCategory != null && singleCategory.cardImage}`} alt="" />
                      </div>
